      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-0 mb-12">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
            <span className="text-[11px] uppercase tracking-[0.2em] text-[#D4FF00] border border-[#D4FF00]/30 px-3 py-2 font-mono">
              {current.range}
            </span>
        ...
        <AnimatePresence mode="wait">
          <div key={pageIndex} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="absolute top-2 left-2 w-3 h-3 border-t border-l border-[#FAF9F6]/20 group-hover:border-[#D4FF00] group-hover:w-6 group-hover:h-6 transition-all duration-300 z-20"></div>
              <div className="absolute top-2 right-2 w-3 h-3 border-t border-r border-[#FAF9F6]/20 group-hover:border-[#D4FF00] group-hover:w-6 group-hover:h-6 transition-all duration-300 z-20"></div>
              ...
              <motion.div
                ...
                className="w-full h-full flex flex-col items-center justify-center group-hover:scale-105 group-hover:opacity-70 transition-all duration-700"
              >
                <div className="w-40 h-40 rounded-full bg-zinc-800 mb-4 border border-zinc-700 group-hover:border-[#D4FF00] transition-colors duration-500"></div>
              </motion.div>
              ...
              >
                <span className="text-[10px] text-[#D4FF00] font-mono uppercase tracking-[0.25em] opacity-0 group-hover:opacity-100 transition-opacity duration-300 block mb-1">
                  {current.large.tag}
                </span>
              ...
              <div className="absolute top-6 right-6 z-20 w-10 h-10 border border-[#444748] flex items-center justify-center group-hover:border-[#D4FF00] group-hover:bg-[#D4FF00] group-hover:text-[#0e0e0e] transition-all duration-300">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                >
                  <span className="text-[9px] font-mono text-[#D4FF00] uppercase tracking-[0.2em] opacity-0 group-hover:opacity-100 transition-opacity duration-300 block mb-0.5">
                    {current.small1.tag}
                  </span>
                ...
                <div className="absolute top-4 right-4 z-20 w-8 h-8 border border-[#444748]/50 flex items-center justify-center group-hover:border-[#D4FF00] group-hover:bg-[#D4FF00] group-hover:text-[#0e0e0e] transition-all duration-300">
