      ...
      <div className="max-w-[1500px] mx-auto px-6 sm:px-10 lg:px-16">
          ...
          {COLUMNS.map((col, idx) => (
            <div key={idx} className="flex flex-col">
              ...
              <div className="relative pt-4 mb-6">
                ...
                <div className="absolute top-0 left-0 right-4 h-[1px] bg-[#050505]" />
                {/* Diagonal 45-degree chamfer notch on right end */}
                <div className="absolute top-0 right-1 w-4 h-[1px] bg-[#050505] origin-top-left rotate-45" />
              ...
              <div className="flex flex-col gap-3.5">
                {col.links.map((link, lIdx) => (
                  <Link
                    key={lIdx}
                    href={link.href}
                    className="text-xs sm:text-[13px] font-sans text-[#FAF9F6]/60 hover:text-[#BFDD25] hover:translate-x-1 transition-all duration-200"
                  >
                    {link.label}
                  </Link>
                ))}
        ...
        <div className="py-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 text-xs font-mono text-[#FAF9F6]/50 uppercase tracking-widest border-b border-[#1c1c1c]">
          ...
          <div className="flex items-center gap-6 text-[#FAF9F6]/80">
            <Link href="#" className="hover:text-[#BFDD25] transition-colors flex items-center gap-1.5">
              <span>LN</span>
