    ...
    <div className="min-h-screen bg-[#030303] text-[#FAF9F6] font-sans selection:bg-[#BFDD25] selection:text-[#030303] flex flex-col relative">
      ...
      <main className="flex-grow pt-28 pb-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        <motion.div
          ...
          className="max-w-xl mx-auto py-12 px-8 bg-[#050505] border border-[#222222] rounded-none text-center mb-16 space-y-6 shadow-2xl"
        >
          <div className="w-16 h-16 bg-[#BFDD25] text-[#030303] flex items-center justify-center mx-auto text-3xl font-bold font-mono">
          ...
          <div>
            <span className="text-xs font-mono text-[#BFDD25] uppercase block mb-2 tracking-widest font-semibold">
              Pembayaran Berhasil
            </span>
          ...
          <div className="p-5 bg-[#050505] text-left text-xs font-mono space-y-3 text-[#FAF9F6]/80 border border-[#222222]">
            ...
            <div className="flex justify-between items-center border-t border-[#222222] pt-3">
              ...
              <span className="text-lg font-bold text-[#BFDD25]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <button
              ...
              className="flex-1 py-3.5 bg-[#050505] hover:bg-[#050505] border border-[#333333] text-white font-mono text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer text-center flex items-center justify-center gap-2"
            >
              <Printer className="w-4 h-4 text-[#BFDD25]" />
              <span>Lihat Faktur Resmi</span>
            </button>
            <Link
              href="/orders"
              className="flex-1 py-3.5 bg-[#BFDD25] hover:bg-white text-[#030303] font-mono text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer text-center"
            >
              Lacak Pengiriman →
            </Link>
          </div>
        ...
        {recommendedGear.length > 0 && (
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/collection" className="font-mono text-xs text-[#BFDD25] hover:underline uppercase tracking-wider">
                Lihat Semua Katalog →
              </Link>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {recommendedGear.map((prod) => (
                <Link
                  ...
                  className="bg-[#050505] border border-[#1c1c1c] p-4 hover:border-[#444444] transition-colors group block"
                >
                  <div className="aspect-square bg-[#050505] overflow-hidden mb-3 relative">
                    <Image
