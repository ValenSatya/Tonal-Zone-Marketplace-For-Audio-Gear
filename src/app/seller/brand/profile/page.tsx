...
export default function BrandProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <span className="px-3 py-1 rounded-full text-xs font-mono font-medium bg-[#121212] text-[#BFDD25] flex items-center gap-1.5">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-white text-black hover:bg-neutral-200 text-xs font-sans font-bold rounded-full transition-all shadow-sm flex items-center gap-2 cursor-pointer"
        >
      ...
      {isSaved && (
        <div className="p-4 rounded-2xl bg-[#0E0E0E] text-white text-xs font-sans flex items-center gap-2.5 shadow-xl">
      ...
      {/* Brand Hero Card (Zero-Stroke Elevation) */}
      <div className="bg-[#0A0A0A] rounded-2xl p-6 sm:p-7 relative shadow-sm">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-5">
          {/* Logo Box */}
          <div className="w-16 h-16 rounded-2xl bg-[#141414] flex items-center justify-center font-mono font-bold text-base text-white shrink-0">
            TANGZU
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <span className="px-3 py-1 rounded-full text-[10px] font-mono bg-[#141414] text-[#71717A]">
                Est. {brandData.foundedYear}
              </span>
            </div>
            <p className="text-xs font-mono text-[#8E8E93] mt-1.5">{brandData.tagline}</p>
            <div className="flex flex-wrap items-center gap-3 text-xs font-mono text-[#71717A] mt-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#0A0A0A] rounded-2xl p-6 sm:p-7 space-y-4 shadow-sm">
            <div className="flex items-center gap-2 pb-1">
              <span className="w-1.5 h-1.5 rounded-full bg-[#BFDD25] shadow-[0_0_6px_rgba(191,221,37,0.7)]" />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#121212] rounded-xl p-4 text-xs font-sans text-white leading-relaxed outline-none border-0 focus:ring-1 focus:ring-white/20 transition-all resize-none"
                />
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-[#0A0A0A] rounded-2xl p-6 sm:p-7 space-y-4 shadow-sm">
            ...
            <div className="space-y-4 text-xs font-mono">
              <div>
                <label className="block text-[10px] uppercase text-[#71717A] mb-1.5">
                ...
                <input
                  ...
                  className="w-full bg-[#121212] rounded-xl px-4 py-3 text-white outline-none border-0 focus:ring-1 focus:ring-white/20 transition-all font-mono"
                />
              </div>
